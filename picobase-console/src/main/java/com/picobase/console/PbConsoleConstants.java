...
public class PbConsoleConstants {
    ...
    public static final String RequestAuthGuest = "guest";
    public static final String RequestAuthAdmin = "admin";
    public static final String RequestAuthRecord = "authRecord";
