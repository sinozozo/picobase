...
public class PbJwtUtil {
	 ...
	 * 底层 saJwtTemplate 对象 
	 */
	public static PbJwtTemplate saJwtTemplate = new PbJwtTemplate();

	/**
	 * 获取底层 saJwtTemplate 对象 
	 * @return /
	 */
	public static PbJwtTemplate getSaJwtTemplate() {
	 ...
	 * @param saJwtTemplate / 
	 */
	public static void setSaJwtTemplate(PbJwtTemplate saJwtTemplate) {
		PbJwtUtil.saJwtTemplate = saJwtTemplate;
	}
